...
namespace Org.Apache.Zookeeper.Txn
{
    ...
    public class SetACLTxn : IRecord, IComparable
    {
        ...
        /// 
        /// </summary>
        private static readonly ILog log = LogManager.GetLogger(typeof(SetACLTxn));
        ...
        public SetACLTxn(string path, System.Collections.Generic.IEnumerable<Data.ACL> acl, int version)
        {
            Path = path;
            Acl = acl;
            Version = version;

...
namespace Org.Apache.Zookeeper.Txn
{
    ...
    public class CreateTxn : IRecord, IComparable
    {
        ...
        /// 
        /// </summary>
        private static readonly ILog log = LogManager.GetLogger(typeof(CreateTxn));
        ...
        /// <param name="parentCVersion"></param>
        public CreateTxn(string path, byte[] data, System.Collections.Generic.IEnumerable<Data.ACL> acl, bool ephemeral, int parentCVersion)
        {
            Path = path;
            Data = data;
            Acl = acl;

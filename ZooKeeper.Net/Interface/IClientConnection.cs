...
namespace ZooKeeper.Net
{
    ...
    public interface IClientConnection : IStartable, IDisposable
    {
        ...
        /// <returns></returns>
        ReplyHeader SubmitRequest(RequestHeader h, IRecord request, IRecord response, WatchRegistration watchRegistration);
        ...
        /// <returns></returns>
        Packet QueuePacket(RequestHeader h, ReplyHeader r, IRecord request, IRecord response, string clientPath, string serverPath, WatchRegistration watchRegistration, object callback, object ctx);
    }
}